      ...
      <div className="ui container">
        <div className="ui container grid-holder">
          ...
          <h5 className="header-details" style={{ textAlign: "center" }}>
            Art is too important not to share. We are sharing with you the
            brilliant works of some of the most reputed and skilled Global
            artists. Explore our extensive catalogue and get ready to
            appreciate, and be enthralled by the creativity depicted. To better
            explore the page, kindly use the filters to tailor the catalogue
            based on your needs. We are sure you will find something that
            interests you.
          </h5>
